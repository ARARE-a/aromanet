...
export const shifts = mysqlTable("shifts", {
  ...
  reviewedByStoreId: int("reviewedByStoreId"),
...
export const messages = mysqlTable("messages", {
  ...
  deletedForStore: boolean("deletedForStore").default(false).notNull(),
  deletedForTherapist: boolean("deletedForTherapist").default(false).notNull(),
  deletedForCustomer: boolean("deletedForCustomer").default(false).notNull(),
  deletedAt: timestamp("deletedAt"),
  deletedByRole: varchar("deletedByRole", { length: 20 }),
