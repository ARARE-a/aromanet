...
export default function TherapistLogin() {
  ...
  return (
    <AuthForm
      ...
      footer={<><span className="text-muted-foreground">新規登録は店舗の招待URLから行ってください</span>{" "}|{" "}<Link href="/demo" className="text-primary font-medium hover:underline">デモを見る</Link>{" "}|{" "}<Link href="/" className="text-muted-foreground hover:underline">ロール選択に戻る</Link></>}
    />
  );
}
